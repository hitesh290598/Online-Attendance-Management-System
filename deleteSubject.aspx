<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="deleteSubject.aspx.cs" Inherits="deleteSubject" %>
...
<div class="col-md-10 maincontent" >
    ...
    <div class="panel panel-default contentinside">
        <div class="panel-heading">Delete Subject</div>
...
<div>
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="table"
        DataKeyNames="subid" DataSourceID="SqlDataSource1">
        <Columns>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT subid, subname, courseid FROM tbl_subject WHERE (subid = @id)">
        <SelectParameters>
...
<table class="table">
<tr><td align="center">
    <asp:Button ID="Button1" runat="server" Text="DELETE" onclick="Button1_Click" CssClass="btn btn-primary"
