<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="deleteProfessor.aspx.cs" Inherits="deleteProfessor" %>
...
<div>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT pid, pname, userid, pass FROM tbl_professor WHERE (pid = @id)">
        <SelectParameters>
